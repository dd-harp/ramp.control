...
itn_model <- setup_bednet_events(itn_model, bednet_jdates, bednet_type, peak_access)
```



```{r bed net contact}
itn_model <- setup_bednet_contact("multiround", itn_model, options=list(contact = rep(0.2, 2))) 
```
